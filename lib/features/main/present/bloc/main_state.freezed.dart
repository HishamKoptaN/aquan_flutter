...
class __$$LogedInImplCopyWithImpl<$Res>
  ...
  @override
  $Res call({
    Object? checkBiom = null,
  }) {
    return _then(_$LogedInImpl(
      checkBiom: null == checkBiom
          ? _value.checkBiom
          : checkBiom // ignore: cast_nullable_to_non_nullable
              as bool,
    ));
  }
}
...
class _$LogedInImpl implements _LogedIn {
  const _$LogedInImpl({required this.checkBiom});

  @override
  final bool checkBiom;

  @override
  String toString() {
    return 'MainState.logedIn(checkBiom: $checkBiom)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.checkBiom, checkBiom) ||
                other.checkBiom == checkBiom));
  }

  @override
  int get hashCode => Object.hash(runtimeType, checkBiom);
...
abstract class _LogedIn implements MainState {
  const factory _LogedIn({required final bool checkBiom}) = _$LogedInImpl;
