...
String getPlansRatesApiResModelToJson(GetPlansRatesApiResModel data) =>
    json.encode(data.toJson());

class GetPlansRatesApiResModel {
  bool status;
  int userPlan;
  int employeeId;
  ...
  factory GetPlansRatesApiResModel.fromJson(Map<String, dynamic> json) =>
      GetPlansRatesApiResModel(
        status: json["status"],
