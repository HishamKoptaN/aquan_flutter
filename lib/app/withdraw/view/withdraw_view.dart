...
// class WithdrawsDepositsView extends StatefulWidget {
//   const WithdrawsDepositsView({super.key});

//   @override
//   State<WithdrawsDepositsView> createState() => _WithdrawsDepositsViewState();
// }

// class _WithdrawsDepositsViewState extends State<WithdrawsDepositsView> {
//   @override
...
//                 //               width: wi,
//                 //               child: Text(
//                 //                 "${(transaction.type == 'deposit') ? transaction.type : transaction.type}",
//                 //                 style: const TextStyle(
//                 //                   fontWeight: FontWeight.bold,
//                 //                   fontSize: 12,
//                 //                 ),
