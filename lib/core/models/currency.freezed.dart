...
class _$CurrencyImpl implements _Currency {
  const _$CurrencyImpl(
      ...
      @JsonKey(name: "name_code") this.nameCode,
  ...
  @override
  String toString() {
    return 'Currency(id: $id, name: $name, status: $status, nameCode: $nameCode, comment: $comment, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, status, nameCode, comment, createdAt, updatedAt);
...
abstract class _Currency implements Currency {
  const factory _Currency(
      ...
      @JsonKey(name: "name_code") final String? nameCode,
